...
export default function BinanceScannerSpotArchived() {
  ...
  return (
    <main className="min-h-screen bg-[#0b0e11] text-[#eaecef] font-sans p-6 overflow-x-hidden">
      <div className="max-w-[3600px] mx-auto">
        ...
        <div className="mb-6 flex items-center gap-3 bg-amber-500/10 border border-amber-500/30 text-amber-400 text-[11px] font-bold uppercase tracking-widest px-4 py-3 rounded-xl">
          <span>⚠</span>
          <span>Versão Arquivada (Spot) — mantida apenas para consulta histórica. O scanner ativo agora roda em Binance Futures (USDT-M).</span>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 border-b border-white/10 pb-6 gap-4">
          <div>
            ...
            <h1 className="text-4xl font-black text-white italic tracking-tighter uppercase">Binance<span className="text-[#f3ba2f]">Scanner</span> <span className="text-[10px] bg-slate-700 text-slate-200 px-2 py-1 rounded not-italic font-bold ml-2 align-middle">v7.3 DATA-SAFE (ARQUIVADO)</span></h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col justify-between">
              ...
              <div className="mt-6 pt-4 border-t border-white/10 text-slate-600 font-black tracking-widest uppercase flex justify-between">
                ...
                <span>v7.3 Data-Safe Build (Arquivado)</span>
              </div>
            </div>
          </div>
        </footer>
